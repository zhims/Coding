...
temp2F(1:1:numPredictions-1) = - temp2F(1,2*numPredictions-1:-1:numPredictions+1); %odd

temp2Fprime(numPredictions:1:2*numPredictions-1) = extractdata(F_Fprime_Pred(2,:));
temp2Fprime(1:1:numPredictions-1) =  temp2Fprime(1,2*numPredictions-1:-1:numPredictions+1); %odd
